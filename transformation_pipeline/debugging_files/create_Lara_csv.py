...
for moving_bone in relevant_parts_dict.keys():
    ...
    with open(csv_file_path, mode='w', newline='') as file:
        ...
        file.write(header)
        ORIG = parts_dict[moving_bone][JointMovement]

        for i in range(300):
            row = []
            # move some joint
            parts_dict[moving_bone][JointMovement] += 1.0
        ...
        # reset bone
        parts_dict[moving_bone][JointMovement] = ORIG
